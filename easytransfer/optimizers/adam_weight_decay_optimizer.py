...
# TODO: 改成基于这个类 from tensorflow.keras.optimizers import Optimizer
class AdamWeightDecayOptimizer(optimizer.Optimizer):
    ...
    def _prepare(self):
        ...
        self.weight_decay_rate_t = ops.convert_to_tensor(self.weight_decay_rate, name="weight_decay_rate")
    ...
    def _create_slots(self, var_list):
        ...
        self._create_non_slot_variable(initial_value=self.beta_1, name="beta1_power", colocate_with=first_var)
        self._create_non_slot_variable(initial_value=self.beta_2, name="beta2_power", colocate_with=first_var)
        for v in var_list:
    ...
    def _finish(self, update_ops, name_scope):
        ...
        with ops.control_dependencies(update_ops):
            ...
            with ops.colocate_with(beta1_power):
                update_beta1 = beta1_power.assign(beta1_power * self.beta_1_t, use_locking=self._use_locking)
                update_beta2 = beta2_power.assign(beta2_power * self.beta_2_t, use_locking=self._use_locking)
